const translations = {
  pt: {
    ...
    summary: [
      ...
      { text: 'Track-in e GeTerr', bold: true },
    ...
    jobs: [
      {
        ...
        location: 'Viçosa, MG · Presencial/distribuído',
        bullets: [
          { pre: 'Desenvolve as plataformas ', bold: 'Track-in e GeTerr', post: ', voltadas à fiscalização e à melhoria da assistência a produtores rurais' },
  ...
  en: {
    ...
    summary: [
      ...
      { text: 'iPlanus', bold: true },
      { text: ', building ' },
      { text: 'Track-in and GeTerr', bold: true },
    ...
    jobs: [
      {
        ...
        location: 'Viçosa, MG · On-site/distributed',
        bullets: [
          { pre: 'Build the ', bold: 'Track-in and GeTerr', post: ' platforms, for oversight and improved assistance to rural producers' },
